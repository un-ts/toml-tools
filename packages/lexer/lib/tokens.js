...
FRAGMENT("partial_time ", makePattern`${f.time_hour}:${f.time_minute}:${f.time_second}${f.time_secfrac}?`);
FRAGMENT("full_date ", makePattern`${f.time_hour}-${f.date_month}-${f.date_mday}`);
